# 🍎 שנה של שאלות — טריוויה לראש השנה

משחק בעברית לכל המשפחה: 12 שאלות, 10 נקודות לתשובה נכונה, הסברים וסיכום תשובות. סדר השאלות והתשובות מתחלף בכל משחק. אין הגבלת זמן.
